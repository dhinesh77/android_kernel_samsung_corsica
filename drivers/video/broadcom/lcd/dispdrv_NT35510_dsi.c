...
CSL_DSI_CM_VC_t DISPDRV_VcCmCfg = 
{
    ...
    LCD_IF_CM_I_RGB565P,  //LCD_IF_CM_I_RGB888U,   // cm_in         //@HW
    LCD_IF_CM_O_RGB565, //LCD_IF_CM_O_RGB888,  // cm_out   
...
static CSL_DSI_CFG_t DISPDRV_dsiCfg = {
    ...
    {800,2},      // hsBitClk        PLL    1000[MHz], DIV by 2 = 500[Mbps]     
    // LP Speed
